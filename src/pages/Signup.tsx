      ...
      <div className="w-full max-w-6xl flex bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12">
          ...
          <form className="space-y-6">
              ...
              {formData.password && (
                <div className="mt-3 space-y-2 text-sm">
                  <div className="flex items-center text-gray-600">
                    ...
                    {passwordRequirements.length && <span className="text-green-500 ml-2">✓</span>}
                  </div>
                  <div className="flex items-center text-gray-600">
            ...
            {/* Sign Up Button */}
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl text-lg font-semibold transition-all transform hover:scale-[1.02]">
              Sign Up →
            </Button>
          ...
          <div className="flex flex-col justify-center items-center w-full p-12 space-y-6">
            ...
            <div className="bg-white/90 backdrop-blur rounded-2xl p-6 w-80 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <span className="text-orange-500 text-sm font-medium">Study Progress</span>
                <Brain className="w-5 h-5 text-blue-600" />
              </div>
              <div className="text-3xl font-bold text-gray-900 mb-2">89.7%</div>
              <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                <div className="w-4/5 h-full bg-gradient-to-r from-orange-400 to-blue-500 rounded-full"></div>
              </div>
